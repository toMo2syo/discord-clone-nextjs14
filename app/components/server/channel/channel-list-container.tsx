...
import { Channel, ChannelType, ServerRoleType } from "@prisma/client";
import { useModal } from "@/app/provider/modal-provider";
import { memo } from "react";
const ChannelListContainer = memo(function ChannelListContainer({
    role,
    channels,
}: {
    role: ServerRoleType | undefined
    channels: Channel[]
}) {
