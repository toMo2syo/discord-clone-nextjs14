...
const ChannelListWrapper = memo(function ChannelListWrapper({
    channels,
}: {
...
// }) {
//     const { openModal } = useModal()
//     const [openItems, setOpenItems] = useState<string[]>(["TEXT"]);
...
//         <>
//             <div className="pr-[10px]">
//                 <Accordion type="multiple" defaultValue={['TEXT']} value={openItems} onValueChange={setOpenItems}>
//                     {Object.values(ChannelType)
//                         .filter(value => typeof value === 'string')
//                         .map(type => (
//                             <AccordionItem key={type} value={type} className="relative text-text-light dark:text-[#949ba4]">
//                                 <AccordionTrigger onClick={() => handleToggle(type)} className="hover:no-underline">
//                                     <div className="w-full flex items-center justify-between">
//                                         <span className="text-xs font-semibold  uppercase">{type} CHANNELS</span>
//                                     </div>
//                                 </AccordionTrigger>
